...
func _process(_delta: float) -> void:
	...
	for b in ratings:
		b.visible = can_rate
		# Wrapped feedback on narrow portrait displays needs its full text height.
		b.position.y = maxf(164,game.feedback_text.position.y+game.feedback_text.get_minimum_size().y+12+b.shape.size.y/2)
