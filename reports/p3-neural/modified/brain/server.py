            ...
            while True:
                ...
                try:
                    ...
                    if kind=='start':
                        ...
                        if outcome not in ('won','lost','quit'):raise ValueError('Invalid outcome')
                        finish(outcome)
